...
var URL_3 = `https://climate-api.open-meteo.com/v1/climate?latitude=${lat}&longitude=${lng}&start_date=1950-01-01&end_date=2050-12-31&daily=temperature_2m_max`
fetch(URL_1)
      .then((response) => {
...
function renderClimate(data) {
      ...
      var maximumTemperatureElement = document.querySelector('.api-overlay[data-property="maximum-temperature"]');
      maximumTemperatureElement.innerHTML = data.maximum.temperature;
}
